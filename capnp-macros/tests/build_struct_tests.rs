...
mod capnp_build {
    ...
    async fn struct_test_assign_from_name() -> capnp::Result<()> {
        fn test_impl(
            ...
            assert_eq!(
                struct_builder.get_text_field()?.to_str(),
                Ok("Example text")
            );
            Ok(())
        }
    ...
    async fn struct_test_struct_pattern() -> capnp::Result<()> {
        fn test_impl(
            ...
            assert_eq!(struct_builder.get_struct_field()?.get_uint_field(), 8);
            Ok(())
        }
        let mut message = capnp::message::Builder::new_default();
        let struct_builder = message.init_root::<test_schema_capnp::test_struct::Builder>();
    ...
    async fn struct_test_list_pattern() -> capnp::Result<()> {
        fn test_impl(
            ...
            let intlist = struct_builder.get_intlist_field()?.into_reader();
    ...
    async fn struct_test_closure() -> capnp::Result<()> {
        fn test_impl(
            ...
            assert_eq!(struct_builder.get_struct_field()?.get_uint_field(), 13);
            Ok(())
        }
        let mut message = capnp::message::Builder::new_default();
        let struct_builder = message.init_root::<test_schema_capnp::test_struct::Builder>();
