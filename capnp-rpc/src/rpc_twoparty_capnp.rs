...
// DO NOT EDIT.
// source: capnp-rpc/schema/rpc-twoparty.capnp
...
impl ::capnp::introspect::Introspect for Side {
  fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema { encoded_node: &side::ENCODED_NODE, annotation_types: side::get_annotation_types }).into() }
}
impl <'a> ::core::convert::From<Side> for ::capnp::dynamic_value::Reader<'a> {
  fn from(e: Side) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema { encoded_node: &side::ENCODED_NODE, annotation_types: side::get_annotation_types }.into()).into() }
}
...
pub static ENCODED_NODE: [::capnp::Word; 28] = [
  ...
  ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
  ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
  ::capnp::word(99, 97, 112, 110, 112, 45, 114, 112),
  ::capnp::word(99, 47, 115, 99, 104, 101, 109, 97),
  ::capnp::word(47, 114, 112, 99, 45, 116, 119, 111),
  ::capnp::word(112, 97, 114, 116, 121, 46, 99, 97),
  ::capnp::word(112, 110, 112, 58, 83, 105, 100, 101),
  ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub mod vat_id {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 35] = [
      ...
      ::capnp::word(47, 114, 112, 99, 45, 116, 119, 111),
      ::capnp::word(112, 97, 114, 116, 121, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 86, 97, 116, 73),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <crate::rpc_twoparty_capnp::Side as ::capnp::introspect::Introspect>::introspect(),
...
pub mod provision_id {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 35] = [
      ...
      ::capnp::word(47, 114, 112, 99, 45, 116, 119, 111),
      ::capnp::word(112, 97, 114, 116, 121, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 80, 114, 111, 118),
      ::capnp::word(105, 115, 105, 111, 110, 73, 100, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(4, 0, 0, 0, 3, 0, 4, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 1, 0, 0, 0, 0, 0),
...
pub mod recipient_id {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 19] = [
      ...
      ::capnp::word(47, 114, 112, 99, 45, 116, 119, 111),
      ::capnp::word(112, 97, 114, 116, 121, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 82, 101, 99, 105),
      ::capnp::word(112, 105, 101, 110, 116, 73, 100, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
    ];
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
...
pub mod third_party_cap_id {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 20] = [
      ...
      ::capnp::word(47, 114, 112, 99, 45, 116, 119, 111),
      ::capnp::word(112, 97, 114, 116, 121, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 84, 104, 105, 114),
      ::capnp::word(100, 80, 97, 114, 116, 121, 67, 97),
...
pub mod join_key_part {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 66] = [
      ...
      ::capnp::word(47, 114, 112, 99, 45, 116, 119, 111),
      ::capnp::word(112, 97, 114, 116, 121, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 74, 111, 105, 110),
      ::capnp::word(75, 101, 121, 80, 97, 114, 116, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
